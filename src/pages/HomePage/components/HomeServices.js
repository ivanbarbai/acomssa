...
import { Grommet, Box, Paragraph, Text, Heading, Card, CardBody, CardHeader, CardFooter, grommet } from 'grommet'
...
const data = [
    {
        icon: <ContabilidadSVG height='4em' />,
        title: 'CONTABILIDAD',
        description: 'This is a Lorem ipsum, etc, etc my bro'
    },
    {
        icon: <FacturacionSVG height='4em' />,
        title: 'FACTURACION',
        description: 'This is a Lorem ipsum, etc, etc my bro'
    },
    {
        icon: <FinanceSVG height='4em' />,
        title: 'FINANZAS',
        description: 'This is a Lorem ipsum, etc, etc my bro'
    },
    {
        icon: <EstructuraSVG height='4em' />,
...
const HomeServices = () => {
    return (
        <Grommet theme={customCard}>
            <Box flex overflow='auto' background='#5587E6'  >
                ...
                <Box flex overflow='auto' pad='large' direction='row-responsive' gap='medium'>
                    {data.map(value => (
                        <Card flex overflow='auto' key={value.title} elevation='large' >
                            <CardHeader align='center' alignContent='center' pad='medium'>
                                {value.icon}
                            </CardHeader>
